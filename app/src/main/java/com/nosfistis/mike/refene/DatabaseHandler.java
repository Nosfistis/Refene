...
public class DatabaseHandler {
     ...
     * @return Returns the insertion unique database ID.
     */
    public long addTransaction(String name, String description, String price, String refID) {
     ...
     */
    public List<String[]> getAllRefeneTransactions(String refID) {
        Cursor cursor = database.rawQuery("SELECT " + MySQLiteHelper.COLUMN_NAME
                ...
                + " GROUP BY " + MySQLiteHelper.COLUMN_NAME, new String[]{refID});

        cursor.moveToFirst();
        List<String[]> peopleList = new ArrayList<>();
        while (!cursor.isAfterLast()) {
            peopleList.add(new String[]{cursor.getString(cursor.getColumnIndex(MySQLiteHelper.COLUMN_NAME)),
                    cursor.getString(cursor.getColumnIndex(MySQLiteHelper.COLUMN_PRICE)),
                    cursor.getString(cursor.getColumnIndex(MySQLiteHelper.COLUMN_PID))});
            cursor.moveToNext();
        }
    ...
    public String[] getTransaction(long id) {
        Cursor cursor = database.query(MySQLiteHelper.TRANSACTIONS_TABLE,
                new String[]{MySQLiteHelper.COLUMN_DESCRIPTION, MySQLiteHelper.COLUMN_PRICE, MySQLiteHelper.COLUMN_PID},
     ...
     */
    public List<String> getAllRefenes() {
        ...
        List<String> refenes = new ArrayList<>();
        cursor.moveToFirst();
        while (!cursor.isAfterLast()) {
            refenes.add(cursor.getString(cursor.getColumnIndex(MySQLiteHelper.COLUMN_RID)));
            cursor.moveToNext();
        }
